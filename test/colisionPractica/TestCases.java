...
public class TestCases {
	...
	public void queSePuedanIncorporarDistintosVehiculos() throws ColitionException {
		...
		assertEquals((Integer) 7, actual.getCantidadDeVehiculos());
		assertFalse(actual.hayColicion());
	}

	@Test//(expected = ColitionException.class)
	public void queChoquenDosVehiculos() {

		Vehiculo unAuto = new Auto("JJZ526", 5, 240, 41.40338, 2.17403);
		Vehiculo unaMoto = new Moto("094AB5", 200, 22.0, 2.0);
		...
		unAuto.actualizarCoordenadas(22.0, 2.0);

		// para conocer los vehiculos que colicionan
		try {
			actual.hayColicion();
		} catch (VehiculosColicionadosExeption e) {
